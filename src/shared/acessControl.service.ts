...
export class AccessContorlService {
  ...
  constructor() {
    this.buildRoles([Role.SubAdmin, Role.Admin]);
    this.buildRoles([Role.Farmer, Role.SubAdmin, Role.Admin]);
    this.buildRoles([Role.Aggregator, Role.SubAdmin, Role.Admin]);
    this.buildRoles([Role.Company, Role.SubAdmin, Role.Admin]);
  }
